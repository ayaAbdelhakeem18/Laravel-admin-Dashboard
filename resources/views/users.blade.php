...
<div class="container mt-5">
    ...
    <div> 
        <a href='/creation/userCreationForm' class="btn btn-primary">Add Data</a>
    </div>
    </div>
    <div class="card-body  table-responsive">
        ...
        @foreach($data as $item)
            <tr >
                ...
                <td class="truncate center">{{$item->email}}</td>
                <td class="truncate center">{{$item->password}}</td>
                ...
                <a href={{url('/show/userShow/'.$item->id)}} class="btn btn-success mr-2"><i class="fa-solid fa-eye fa-beat"></i></a></i>
