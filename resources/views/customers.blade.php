...
<div class="container mt-5">
    ...
    <div> 
        <a href='/creation/customerCreationForm' class="btn btn-primary">Add Data</a>
    </div>
    </div>
    <div class="card-body  table-responsive">
        ...
        @foreach($data as $item)
            <tr >
                ...
                <td class="truncate center">{{$item->firstName}}</td>
                <td class="truncate center">{{$item->lastName}}</td>
                <td class="truncate center">{{$item->phone}}</td>
                <td class="truncate center">{{$item->city}}</td>
                <td class="truncate center">{{$item->state}}</td>
                <td class="truncate center">{{$item->address}}</td>
                <td class="center">{{$item->zip_code}}</td>
                ...
                <a href={{url('/show/customerShow/'.$item->id)}} class="btn btn-success"><i class="fa-solid fa-eye fa-beat"></i></a></i>
